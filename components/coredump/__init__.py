...
CONF_ENABLE_TEST_CRASH = "enable_test_crash"
    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_ENABLE_TEST_CRASH, default=False): cv.boolean,
        }
...
async def to_code(config):
    ...
    if config[CONF_ENABLE_TEST_CRASH]:
        cg.add_define("USE_COREDUMP_ENABLE_TEST_CRASH")
